...
var afterHooks, beforeHooks, defer, injector, sequence, util;
    ...
    return function(done, inject) {
      ...
      if (opts.context.leafOnly) {
        ...
        if (util.argsOf(control.beforeEach)[0] === 'done') {
          if (!opts.context.global) {
            return control.beforeEach.call(this, done);
          }
          return control.beforeEach.call(null, done);
        } else {
          if (!opts.context.global) {
            control.beforeEach.call(this);
          }
          if (opts.context.global) {
            control.beforeEach.call(null);
          }
          return done();
        }
      } else {
    ...
    return function(done, inject) {
      ...
      return sequence([
        function() {
          ...
          step = defer();
          control.afterEach.call(target, function(result) {
            return step.resolve(result);
          });
          return step.promise;
        }
    ...
    return function(done, inject) {
      ...
      if (typeof control.afterAll === 'function') {
        if (util.argsOf(control.afterAll)[0] === 'done') {
          if (!opts.context.global) {
            return control.afterAll.call(this, finished);
          }
          return control.afterAll.call(null, finished);
        } else {
          if (!opts.context.global) {
            control.afterAll.call(this);
          }
          if (opts.context.global) {
            control.afterAll.call(null);
          }
        }
      }
      return finished();
