...
module.exports = compiler = {
  compile: function(notice, config, callback) {
    var error, file, inFile, js, outFile, outPath, source;
    inFile = config.file;
  ...
  ensureSpec: function(notice, config, callback) {
    var basename, buff, classname, content, create, error, file, outFile, specFile;
    create = false;
    outFile = config.file.replace(config.src, '');
